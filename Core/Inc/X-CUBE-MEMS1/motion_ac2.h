...
/**
  * @}
  */
char MotionAC2_LoadCalFromNVM (unsigned short intdataSize, unsigned int *data){
	return (char)1; // Not implemented
}

/**
  * @}
  */
char MotionAC2_SaveCalInNVM (unsigned short intdataSize, unsigned int *data){
	return (char)1; // Not implemented
}
