...
void HAL_OSPI_MspInit(OSPI_HandleTypeDef *hospi) {
	...
	if (hospi->Instance == OCTOSPI1) {
		...
		GPIO_InitStruct.Pin = OCTOSPI_F_IO0_Pin | OCTOSPI_F_IO1_Pin
				| OCTOSPI_F_IO2_Pin | OCTOSPI_F_IO3_Pin | OCTOSPI_F_CLK_P_Pin
				| OCTOSPI_F_DQS_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef *hospi) {
	if (hospi->Instance == OCTOSPI1) {
		...
		HAL_GPIO_DeInit(GPIOF,
				OCTOSPI_R_IO0_Pin | OCTOSPI_R_IO2_Pin | OCTOSPI_R_IO1_Pin
						| OCTOSPI_R_IO3_Pin);
		...
		HAL_GPIO_DeInit(GPIOH,
				OCTOSPI_F_IO7_Pin | OCTOSPI_F_IO5_Pin | OCTOSPI_F_IO6_Pin
						| OCTOSPI_F_IO4_Pin);

		HAL_GPIO_DeInit(GPIOF,
				OCTOSPI_F_IO0_Pin | OCTOSPI_F_IO1_Pin | OCTOSPI_F_IO2_Pin
						| OCTOSPI_F_IO3_Pin | OCTOSPI_F_CLK_P_Pin
						| OCTOSPI_F_DQS_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef *hspi) {
	...
	if (hspi->Instance == SPI2) {
		...
		/**SPI2 GPIO Configuration
		 ...
		 PB12     ------> SPI2_NSS
		 */
		GPIO_InitStruct.Pin = WRLS_SPI2_MOSI_Pin | WRLS_SPI2_MISO_Pin
				| WRLS_SPI2_SCK_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef *hspi) {
	if (hspi->Instance == SPI2) {
		...
		HAL_GPIO_DeInit(GPIOD,
				WRLS_SPI2_MOSI_Pin | WRLS_SPI2_MISO_Pin | WRLS_SPI2_SCK_Pin);
