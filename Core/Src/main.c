...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PE14 PE13 PE12 */
  ...
  /*Configure GPIO pin : Mems_INT_IIS2MDCD9_Pin_Pin */
  GPIO_InitStruct.Pin = Mems_INT_IIS2MDCD9_Pin_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(Mems_INT_IIS2MDCD9_Pin_GPIO_Port, &GPIO_InitStruct);
